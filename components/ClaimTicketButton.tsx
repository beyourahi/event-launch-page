...
interface ClaimTicketButton extends CurrentFrameworkProps {
    buttonRef: React.RefObject<HTMLButtonElement>;
}

export const ClaimTicketButton = ({ currentFramework, buttonRef }: ClaimTicketButton) => (
    <div className="mb-8">
        <button
            ref={buttonRef}
            className={cn(
                "rounded-md px-6 py-3 text-sm font-semibold text-black transition-colors duration-200",
                {
                    ...
                    "bg-sky-300 hover:bg-sky-400 active:bg-sky-600": currentFramework === "safari",
                    ...
                    "bg-red-300 hover:bg-red-400 active:bg-red-600": currentFramework === "mobile",
